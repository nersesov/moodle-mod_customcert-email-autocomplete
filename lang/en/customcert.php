...
$string['completionissued'] = 'An email containing this certificate has been sent to the student.';
$string['completionissued_help'] = 'Students who receive a certificate will have the activity marked as complete. This option requires that email to students is enabled either globally or for this specific certificate.';
$string['completionissuedemailerror'] = 'Activity completion on certificate issue requires that email to students is enabled.';
$string['copy'] = 'Copy';
